...
packages = c("parallel","doParallel","doSNOW","readr","dplyr","caret","pROC","ggplot2","gridExtra","mice","xgboost","gbm","e1071")
...
pred1 = cbind(test_X$RecordID,fitted_saleprice)
```
